...
func (tr *BackupSnapshotExportJob) GetObservation() (map[string]interface{}, error) {
...
func (tr *BackupSnapshotExportJob) SetObservation(obs map[string]interface{}) error {
...
func (tr *BackupSnapshotExportJob) GetParameters() (map[string]interface{}, error) {
...
func (tr *BackupSnapshotExportJob) SetParameters(params map[string]interface{}) error {
