...
type AwsConfigParameters struct {
	...
	AtlasAssumedRoleExternalID *string `json:"atlasAssumedRoleExternalId" tf:"atlas_assumed_role_external_id,omitempty"`

	// +kubebuilder:validation:Required
	AtlasAwsAccountArn *string `json:"atlasAwsAccountArn" tf:"atlas_aws_account_arn,omitempty"`
}
