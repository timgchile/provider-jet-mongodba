...
func (tr *BackupSnapshotExportBucket) GetObservation() (map[string]interface{}, error) {
...
func (tr *BackupSnapshotExportBucket) SetObservation(obs map[string]interface{}) error {
...
func (tr *BackupSnapshotExportBucket) GetParameters() (map[string]interface{}, error) {
...
func (tr *BackupSnapshotExportBucket) SetParameters(params map[string]interface{}) error {
