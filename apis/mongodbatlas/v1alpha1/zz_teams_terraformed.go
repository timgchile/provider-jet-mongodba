...
func (tr *Teams) GetObservation() (map[string]interface{}, error) {
...
func (tr *Teams) SetObservation(obs map[string]interface{}) error {
...
func (tr *Teams) GetParameters() (map[string]interface{}, error) {
...
func (tr *Teams) SetParameters(params map[string]interface{}) error {
