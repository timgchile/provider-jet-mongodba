...
PROJECT_NAME := provider-jet-mongodba
PROJECT_REPO := github.com/timgchile/$(PROJECT_NAME)

export TERRAFORM_VERSION := 1.1.6

export TERRAFORM_PROVIDER_SOURCE := timgchile/mongodbatlas
export TERRAFORM_PROVIDER_VERSION := 1.3.8
export TERRAFORM_PROVIDER_DOWNLOAD_NAME := terraform-provider-mongodbatlas
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX := https://github.com/timgchile/terraform-provider-mongodbatlas/releases/download/v1.3.8
...
IMAGES = provider-jet-mongodba provider-jet-mongodba-controller
